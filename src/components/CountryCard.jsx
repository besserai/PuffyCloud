...
const CountryCard = ({ country }) => {
    ...
    useEffect(() => {
        ...
        if (country["Photo Header"]) {
            // console.log(country["Photo Header"])
            setPhotoHeader(country["Photo Header"][0].url)
        }
    }
        , [])
